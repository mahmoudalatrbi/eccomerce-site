          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Form className="d-lg-none my-2" onSubmit={handleSearch}>
              <div className="d-flex">
                ...
                />
                <Button className='Btn' variant="outline-light" type="submit">
            ...
            <Nav className="d-flex align-items-center">
              ...
              <Button
                ...
                size="sm"
                className="me-3 d-flex align-items-center Btn"
              ...
              <Nav.Link
                as={Link}
                to="/cart"
                className="position-relative d-flex align-items-center px-3 me-2"
              >
              ...
              {isAuthenticated ? (
                ...
                >
                  ...
                  <NavDropdown.Header className="text-center py-3">
                    <div
                      className="bg-dark text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2"
                      style={{
                        width: '50px',
                        height: '50px',
                        fontSize: '20px',
